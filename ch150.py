...
# set the problem
ch150 = ACO.TCProblem(data, 'EUC_2D')

# ant colony
ch150.antColony(3.5, 3.5, 0.2, 30)

# set stop condition
ch150.set_stop_condition('ITER', 150)

# solve the problem
for i in range(N):
    print(i)
    ch150.solve()
    path[i] = ch150.results.shortestPath
    tour[i] = ch150.results.shortestTour
    error[i] = (ch150.results.shortestTour - optimalTour)/optimalTour
...
# save results
txt = '{},{},{},{},{},{}\n'.format(problem_name,ch150.N,optimalTour,shortestTour,averageTour,mean_error)
